...
//Canvas and context are global
var canvas;
var ctx;

//Global variables the Mandelbrot graphics code uses to compute the set and display it
var i_max = 1.5;
var i_min = -1.5;
var r_min = -2.5;
var r_max = 1.5;
...
//
// packages up the data we need to send to the worker (for computing a row of pixels by the worker)
//
